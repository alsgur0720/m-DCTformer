...
class Attention(nn.Module):
    def __init__(self, dim, num_heads, bias):
        ...
        # self.weight_x = nn.Conv2d(dim*3, dim*3, kernel_size=(3,1), stride=1, padding=(1,0), groups=dim*3, bias=bias)
        # self.weight_y = nn.Conv2d(dim*3, dim*3, kernel_size=(1,3), stride=1, padding=(0,1), groups=dim*3, bias=bias)
